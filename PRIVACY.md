...
L’extension enregistre localement sept préférences : l’affichage des signaux à confiance modérée, l’activation du surlignage automatique, l’activation de l’analyse de sécurité, l’affichage de l’éditeur d’un média, la comparaison des compteurs entre deux visites, la prise en compte des retours de l’utilisateur et la mémorisation des domaines analysés. Elle ne collecte ni identité, ni données d’utilisation, ni communications personnelles.
